...
contract Q13 {
    ...
    */
    function getNumber(uint _n) public pure returns(string memory) {
            if(_n % 3 == 0){
                return "A";
            }else if(_n % 3 == 1){
                return "B";
...
contract Q18 {
    ...
    */
    ...
    function getBirthday(string memory _name, uint _birthday)public {
...
contract Q19 {
    ...
    */
   function getTwice(uint _n)public pure returns(uint) {
    require(_n<1000);
    return _n * 2;
   } 
}
